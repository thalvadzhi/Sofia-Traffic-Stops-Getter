...
desc_file_name = os.path.join(ROOT_DIR, "descriptions_getter","descriptions.txt")
log_file_name = os.path.join(ROOT_DIR, "stops_log.txt")
direction_template = "{0} - {1}"
stop_identity = "{0},{1},{2}={3}"
hash_file_name = os.path.join(ROOT_DIR, "descriptions_getter", "hash.txt")
hash_file_name_temp = os.path.join(ROOT_DIR, "descriptions_getter", "new_hash.txt")
